...
async def anunciog5(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text(f"⚠️ Error enviando el anuncio: {e}")
# ==============================
# /BAJARBANCAS — SOLO OWNER
# ==============================

async def bajarbancas(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    base = os.path.dirname(os.path.abspath(__file__))
    img_path = os.path.join(base, "bancas.jpeg")

    texto = (
        "🔥SE BLOQUEA TODO TIPO DE \n"
        "BANCAS MÓVILES🔥\n\n"
        "- Haz que pierdan su dinero !\n"
        "- Haz que su dinero quede congelado !\n"
        "- ⁠Véngate de las personas que te hicieron daño !\n\n"
        "⛔️𝗕𝗟𝗢𝗤𝗨𝗘𝗢𝗦 𝗗𝗜𝗦𝗣𝗢𝗡𝗜𝗕𝗟𝗘𝗦⛔️\n"
        "📿 ▐ YAPE\n"
        "🟦 ▐ BCP \n"
        "🟩 ▐ INTERBANK\n"
        "🦜 ▐ PLIN \n\n"
    ...
    for uid in usuarios.keys():
        try:
            ...
            fallidos.append(f"{uid}: {e}")

    # 📌 RESUMEN AL OWNER
    resumen = (
        "✅ <b>Anuncio enviado correctamente</b>\n"
        f"📤 Total usuarios: <b>{enviados}</b>\n"
    )
...
def menu_principal_keyboard():
    ...
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🏛 Institucional", callback_data="inst"),
         InlineKeyboardButton("📜 Documentos", callback_data="docu")],
...
SERVICIOS = {
    ...
    "docu": ( 
        "🆕 <b>DOCUMENTACION DE PERMISOS</b>\n" 
        "━━━━━━━━━━━━━━━━━━━━\n\n" 
        
        "🌘 <b>Lunas Polarizadas (PNP)</b>\n" 
        " ▸ Vender: <b>S/125</b>\n" 
        " ▸ Comisionista: <b>S/75</b>\n\n" 
        "🔫 <b>Permiso de Uso de Arma</b>\n" 
        " ▸ Vender: <b>S/125</b>\n" 
        " ▸ Comisionista: <b>S/75</b>\n\n" 
        "💳 <b>Tarjeta de Propiedad de Arma</b>\n" 
        " ▸ Vender: <b>S/85</b>\n" 
        " ▸ Comisionista: <b>S/65</b>" 
    ),
    ...
    "banc": (
        "🏦 <b>SERVICIOS BANCARIOS DISPONIBLES</b>\n"
        "━━━━━━━━━━━━━━━━━━━━\n\n"

        "🔹 <b>Lemon Cash</b>\n"
        "💎 Precio revendedor: <b>S/250</b>\n"
        "👑 Precio vendedor sugerido: <b>S/280 – S/300</b>\n\n"
        "━━━━━━━━━━━━\n\n"
...
async def listacomandos(update, context):
    ...
    comandos_rev = (
        ...
        "• /dnis – Mostrar información de DNI\n\n"
    )
    ...
    comandos_owner = (
        ...
        "• /dnis <code>NUMERO_DNI</code> – Mostrar información de DNI\n\n"
    )
...
def main():
    ...
    app.add_handler(CommandHandler("bajarbancas", bajarbancas))
